...
func TestArrayBufferGoWrapper(t *testing.T) {
	...
	buf1 := ValueExport(ret).(ArrayBuffer)
	data1 := buf1.Bytes()
...
func TestTypedArrayExport(t *testing.T) {
	...
	t.Run("uint8", func(t *testing.T) {
		...
		if a, ok := ValueExport(v).([]uint8); ok {
	...
	t.Run("uint16", func(t *testing.T) {
		...
		if a, ok := ValueExport(v).([]uint16); ok {
	...
	t.Run("int16", func(t *testing.T) {
		...
		if a, ok := ValueExport(v).([]int16); ok {
	...
	t.Run("uint32", func(t *testing.T) {
		...
		if a, ok := ValueExport(v).([]uint32); ok {
	...
	t.Run("int32", func(t *testing.T) {
		...
		if a, ok := ValueExport(v).([]int32); ok {
			if len(a) != 2 || a[0] != 1 || a[1] != -123456 {
				t.Fatal(a)
			}
		} else {
	...
	t.Run("float32", func(t *testing.T) {
		...
		if a, ok := ValueExport(v).([]float32); ok {
	...
	t.Run("float64", func(t *testing.T) {
		...
		if a, ok := ValueExport(v).([]float64); ok {
	...
	t.Run("bigint64", func(t *testing.T) {
		...
		if a, ok := ValueExport(v).([]int64); ok {
			if len(a) != 2 || a[0] != 1 || a[1] != 2 {
				t.Fatal(a)
			}
		} else {
	...
	t.Run("biguint64", func(t *testing.T) {
		...
		if a, ok := ValueExport(v).([]uint64); ok {
			if len(a) != 2 || a[0] != 1 || a[1] != 2 {
				t.Fatal(a)
			}
		} else {
