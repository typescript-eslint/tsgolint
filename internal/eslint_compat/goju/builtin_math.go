...
func (r *Runtime) math_abs(call FunctionCall) Value {
	return floatToValue(math.Abs(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_acos(call FunctionCall) Value {
	return floatToValue(math.Acos(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_acosh(call FunctionCall) Value {
	return floatToValue(math.Acosh(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_asin(call FunctionCall) Value {
	return floatToValue(math.Asin(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_asinh(call FunctionCall) Value {
	return floatToValue(math.Asinh(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_atan(call FunctionCall) Value {
	return floatToValue(math.Atan(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_atanh(call FunctionCall) Value {
	return floatToValue(math.Atanh(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_atan2(call FunctionCall) Value {
	y := ValueToFloat(call.Argument(0))
	x := ValueToFloat(call.Argument(1))

	return floatToValue(math.Atan2(y, x))
}

func (r *Runtime) math_cbrt(call FunctionCall) Value {
	return floatToValue(math.Cbrt(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_ceil(call FunctionCall) Value {
	return floatToValue(math.Ceil(ValueToFloat(call.Argument(0))))
}
...
func (r *Runtime) math_cos(call FunctionCall) Value {
	return floatToValue(math.Cos(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_cosh(call FunctionCall) Value {
	return floatToValue(math.Cosh(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_exp(call FunctionCall) Value {
	return floatToValue(math.Exp(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_expm1(call FunctionCall) Value {
	return floatToValue(math.Expm1(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_floor(call FunctionCall) Value {
	return floatToValue(math.Floor(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_fround(call FunctionCall) Value {
	return floatToValue(float64(float32(ValueToFloat(call.Argument(0)))))
}
...
func (r *Runtime) math_log(call FunctionCall) Value {
	return floatToValue(math.Log(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_log1p(call FunctionCall) Value {
	return floatToValue(math.Log1p(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_log10(call FunctionCall) Value {
	return floatToValue(math.Log10(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_log2(call FunctionCall) Value {
	return floatToValue(math.Log2(ValueToFloat(call.Argument(0))))
}
...
func (r *Runtime) math_round(call FunctionCall) Value {
	f := ValueToFloat(call.Argument(0))
	if math.IsNaN(f) {
		return _NaN
	}
...
func (r *Runtime) math_sin(call FunctionCall) Value {
	return floatToValue(math.Sin(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_sinh(call FunctionCall) Value {
	return floatToValue(math.Sinh(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_sqrt(call FunctionCall) Value {
	return floatToValue(math.Sqrt(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_tan(call FunctionCall) Value {
	return floatToValue(math.Tan(ValueToFloat(call.Argument(0))))
}

func (r *Runtime) math_tanh(call FunctionCall) Value {
	return floatToValue(math.Tanh(ValueToFloat(call.Argument(0))))
}
...
func (r *Runtime) math_trunc(call FunctionCall) Value {
	...
	return floatToValue(math.Trunc(ValueToFloat(arg)))
}
