...
func (i *importedString) ToInteger() int64 {
	...
	return ValueToInteger(asciiString(i.s))
}
...
func (i *importedString) ToFloat() float64 {
	...
	return ValueToFloat(asciiString(i.s))
}

func (i *importedString) ToNumber() Value {
	i.ensureScanned()
	if i.u != nil {
		return ValueToNumber(i.u)
	}
	return ValueToNumber(asciiString(i.s))
}
...
func (i *importedString) SameAs(other Value) bool {
	return ValueStrictEquals(i, other)
}

func (i *importedString) Equals(other Value) bool {
	if ValueStrictEquals(i, other) {
		return true
	}
	i.ensureScanned()
	if i.u != nil {
		return ValueEquals(i.u, other)
	}
	return ValueEquals(asciiString(i.s), other)
}
...
func (i *importedString) baseObject(r *Runtime) *Object {
	i.ensureScanned()
	if i.u != nil {
		return ValueBaseObject(r, i.u)
	}
	return ValueBaseObject(r, asciiString(i.s))
}

func (i *importedString) hash(hasher *maphash.Hash) uint64 {
	i.ensureScanned()
	if i.u != nil {
		return ValueHash(i.u, hasher)
	}
	return ValueHash(asciiString(i.s), hasher)
}
...
func (i *importedString) CompareTo(v String) int {
	return strings.Compare(i.s, ValueToString(v))
}
