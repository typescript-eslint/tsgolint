...
var (
	...
	stringEmptyPlaceholder       String = asciiString("<...>")
...
func (s *stringObject) getIdx(idx valueInt, receiver Value) Value {
	...
	return s.baseObject.getStr(ValueToUnistring(idx), receiver)
}
...
func (s *stringObject) getOwnPropIdx(idx valueInt) Value {
	...
	return s.baseObject.getOwnPropStr(ValueToUnistring(idx))
}
...
func (s *stringObject) setOwnIdx(idx valueInt, val Value, throw bool) bool {
	...
	return s.baseObject.setOwnStr(ValueToUnistring(idx), val, throw)
}
...
func (s *stringObject) defineOwnPropertyIdx(idx valueInt, descr PropertyDescriptor, throw bool) bool {
	...
	return s.baseObject.defineOwnPropertyStr(ValueToUnistring(idx), descr, throw)
}
...
func (s *stringObject) deleteIdx(idx valueInt, throw bool) bool {
	...
	return s.baseObject.deleteStr(ValueToUnistring(idx), throw)
}
...
func (s *stringObject) hasOwnPropertyIdx(idx valueInt) bool {
	...
	return s.baseObject.hasOwnPropertyStr(ValueToUnistring(idx))
}
