...
func (v *valueBigInt) Equals(other Value) bool {
	...
	case valueBool:
		return (*big.Int)(v).Int64() == ValueToInteger(o)
	case *Object:
		return ValueEquals(v, o.toPrimitiveNumber())
	}
	return false
}
...
func toBigInt(value Value) *valueBigInt {
	...
	case valueBool:
		return (*valueBigInt)(big.NewInt(ValueToInteger(prim)))
	case *Symbol:
...
func numberToBigInt(v Value) *valueBigInt {
	...
	case *valueBigInt:
		return v
	case valueInt:
		return (*valueBigInt)(big.NewInt(ValueToInteger(v)))
	case valueFloat:
...
func (r *Runtime) bigintproto_toString(call FunctionCall) Value {
	...
	if radix == _undefined {
		...
		radixMV = int(ValueToInteger(radix))
...
func (r *Runtime) bigint_asIntN(call FunctionCall) Value {
	...
	bits := r.toIndex(ValueToNumber(call.Argument(0)))
	if bits < 0 {
