...
func (s unicodeString) toTrimmedUTF8() string {
	...
	return strings.Trim(ValueToString(s), parser.WhitespaceChars)
}

func (s unicodeString) ToNumber() Value {
	return ValueToNumber(asciiString(s.toTrimmedUTF8()))
}
...
func (s unicodeString) SameAs(other Value) bool {
	return ValueStrictEquals(s, other)
}

func (s unicodeString) Equals(other Value) bool {
	if ValueStrictEquals(s, other) {
		return true
	}
...
func (s unicodeString) CompareTo(other String) int {
	...
	return strings.Compare(ValueToString(s), ValueToString(other))
}
...
func (s unicodeString) toLower() String {
	return toLower(ValueToString(s))
}

func (s unicodeString) toUpper() String {
	caser := cases.Upper(language.Und)
	return newStringValue(caser.String(ValueToString(s)))
}
