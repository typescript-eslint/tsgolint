...
func (r *Runtime) numberproto_toFixed(call FunctionCall) Value {
	num := ValueToFloat(r.toNumber(call.This))
	prec := ValueToInteger(call.Argument(0))
