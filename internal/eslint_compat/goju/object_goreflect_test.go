...
func TestGoReflectSet(t *testing.T) {
	...
	if res, ok := ValueExport(r.Get("o")).(O); ok {
		if res.X != 6 {
...
func TestGoReflectCustomIntUnbox(t *testing.T) {
	...
	if !ValueStrictEquals(v, intToValue(42)) {
...
func TestGoReflectMethod(t *testing.T) {
	...
	if !ValueStrictEquals(v, asciiString("test 123")) {
...
func TestGoReflectMethodPtr(t *testing.T) {
	...
	if !ValueStrictEquals(v, asciiString("42")) {
...
func TestGoReflectCustomNaming(t *testing.T) {
	...
	t.Run("get property", func(t *testing.T) {
		...
		if !ValueStrictEquals(v, newStringValue(o.A)) {
	...
	t.Run("enumerate properties", func(t *testing.T) {
		...
		if !reflect.DeepEqual(ValueExport(v), []interface{}{"b"}) {
			t.Fatalf("Expected [\"b\"], got %v", ValueExport(v))
		}
	})
}
...
`
	...
	if expected != ValueToString(v) {
		t.Fatalf("Expected '%s', got '%s'", expected, ValueToString(v))
	}
...
func TestGoReflectToPrimitive(t *testing.T) {
	...
	f := func(expr string, expected Value, t *testing.T) {
		...
		if IsNaN(expected) {
			...
			if ValueStrictEquals(v, expected) {
				return
			}
		}
